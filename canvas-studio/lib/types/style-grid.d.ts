...
export declare const STYLE_DEMO_MAP: Readonly<Record<string, string>>;
/** 选项命中风格预设时返回对应 skill 名（用于 GIF 预览），否则 null：精确优先，再走宽松匹配。 */
export declare function styleDemoSkill(option: string): string | null;
/**
 ...
 */
export declare function shouldRenderStyleGrid(options: readonly string[]): boolean;
