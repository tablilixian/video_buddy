...
- **主线编号 `CV-xxx`** — 画布侧全部条目（缺陷 + 优化 + 小需求）共用一条序列，已编到 CV-098。新条目从 **CV-099** 起。（2026-09-04 修正漂移：CV-096 品牌图标落地时未同步本行，此处一并追平）
...
| 已修复·待验收 | 38 | CV-008, 049, 052, 056~060, 062~074, 076~083, 088, 091~098 |
| 已完成·待验收 | 1 | CV-061 |
