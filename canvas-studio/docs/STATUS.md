...
- **主线编号 `CV-xxx`** — 画布侧全部条目（缺陷 + 优化 + 小需求）共用一条序列，已编到 CV-105。新条目从 **CV-106** 起。（2026-09-07：CV-105 C3 尾帧链；CV-104 C2 注入纪律 + 资产卡覆盖；CV-102 无 fork 附件旁路 / CV-103 C1 一致性资产锚点）。（2026-09-07：CV-101 东方异境 skill 外挂试跑）
