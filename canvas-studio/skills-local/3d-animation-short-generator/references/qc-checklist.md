...
- Group single-shot video clips as `<title> shot clips`.
...
- If a single-shot video clip is re-rendered, assembly, BGM matching, and final composite must use the new clip.
