 ...
 * 与加头部之前一模一样。
 */
export declare const NODE_HEAD_HEIGHT = 26;
export declare const NODE_FOOT_HEIGHT = 22;
export declare const NODE_CHROME_HEIGHT: number;
/**
 ...
 */
export declare const DEFAULT_MEDIA_BOX: {
    readonly width: 260;
    readonly height: 180;
};
 ...
 */
export declare function frameSizeOf(media: {
    width: number;
    height: number;
}): MediaDisplaySize;
/**
 ...
 * 地板取 1 防除零。
 */
export declare function mediaBoxOf(frame: {
    width: number;
    height: number;
}): MediaDisplaySize;
/**
 ...
 */
export declare const DEFAULT_NODE_SIZE: MediaDisplaySize;
/**
