...
export const STYLE_DEMO_MAP: Readonly<Record<string, string>> = {
...
export function styleDemoSkill(option: string): string | null {
 ...
 */
export function shouldRenderStyleGrid(options: readonly string[]): boolean {
