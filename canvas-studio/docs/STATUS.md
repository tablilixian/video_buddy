...
- **主线编号 `CV-xxx`** — 画布侧全部条目（缺陷 + 优化 + 小需求）共用一条序列，已编到 CV-100。新条目从 **CV-101** 起。（2026-09-06：CV-099 项目预置 + CV-100 剧本门禁落地）
...
| 已修复·待验收 | 40 | CV-008, 049, 052, 056~060, 062~074, 076~083, 088, 091~098, 099, 100 |
| 已完成·待验收 | 1 | CV-061 |
