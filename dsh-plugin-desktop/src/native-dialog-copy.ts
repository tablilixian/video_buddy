...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: 'Open DSH Terminal to update or remove the failing third-party plugin, then restart VideoBuddy.',
    openTerminal: 'Open DSH Terminal',
    restart: 'Restart VideoBuddy',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'VideoBuddy Update Available',
    updateAvailableMessage: version => `VideoBuddy ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'VideoBuddy could not check for updates.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'VideoBuddy Is Up to Date',
    upToDateMessage: 'No newer version of VideoBuddy is available.',
    installedVersion: version => `Installed version: ${version}`,
    installerUnavailable: 'Installer downloads are unavailable in this build.',
    updateDownloadedTitle: 'VideoBuddy Update Downloaded',
    updateReady: version => `VideoBuddy ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace VideoBuddy in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart VideoBuddy and run the installer now?',
    ...
    updateInstalled: version => `VideoBuddy ${version} has been installed.`,
    ...
    terminalErrorMessage: 'VideoBuddy could not open a terminal.',
    diagnosticsErrorTitle: 'Unable to Export Diagnostics',
    diagnosticsErrorMessage: 'VideoBuddy could not export the diagnostic archive.',
  ...
  zh: {
    ...
    pluginRecoveryInstructions: '请打开 DSH 终端更新或移除失败的第三方插件，然后重启 VideoBuddy。',
    openTerminal: '打开 DSH 终端',
    restart: '重启 VideoBuddy',
    dismiss: '关闭',
    updateAvailableTitle: 'VideoBuddy 有可用更新',
    updateAvailableMessage: version => `VideoBuddy ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: 'VideoBuddy 无法检查更新。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'VideoBuddy 已是最新版本',
    upToDateMessage: '当前没有更新版本的 VideoBuddy。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '此构建不支持下载安装包。',
    updateDownloadedTitle: 'VideoBuddy 更新已下载',
    updateReady: version => `VideoBuddy ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 VideoBuddy，然后重新打开。',
    windowsInstallQuestion: '现在重启 VideoBuddy 并运行安装程序？',
