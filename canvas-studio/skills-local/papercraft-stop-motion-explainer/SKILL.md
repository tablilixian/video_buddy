...
When this Skill proceeds from planning/prompting into actual video generation, the video generation model is fixed to MiniMax-H3; this project has no model-selection step — do not ask the user or offer other model options.
