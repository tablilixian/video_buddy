...
- **主线编号 `CV-xxx`** — 画布侧全部条目（缺陷 + 优化 + 小需求）共用一条序列，已编到 CV-067。新条目从 **CV-068** 起。
...
| 已修复·待验收 | 14 | CV-049, 052, 056~060, 062~068 |
| 已完成·待验收 | 1 | CV-061 |
| 待处理 | 17 | CV-005~008, 021, 039, 040, 042, 043, 046~048, 050, 051, 053~055 |
| 待拍板 | 1 | CV-036 |
