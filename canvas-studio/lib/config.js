 ...
 */
export const MEGAPIXELS_BY_RESOLUTION = {
    '480p': 0.4,
    '768p': 1.0,
    '2k': 2.0,
};
...
export function isVideoResolution(value) {
 ...
 */
export function sizeForAspectRatio(aspectRatio, resolution = DEFAULT_RESOLUTION) {
    switch (aspectRatio) {
        case '9:16': {
